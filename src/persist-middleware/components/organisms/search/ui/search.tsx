...
import { useInput } from "@persist-middleware/shared/hooks/useInput";
...
import { selectSuggestions } from "@persist-middleware/app/store/todos/todos-selectors";
...
export function Search() {
  ...
  const debouncedQuery = useDebounce(search.value, 200);
