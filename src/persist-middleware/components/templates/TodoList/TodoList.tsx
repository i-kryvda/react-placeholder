...
import {
  ...
  selectFilter,
  selectSearchTodos,
} from "@persist-middleware/app/store/todos/todos-selectors";
import { clearCompleted } from "@persist-middleware/app/store/todos/todos-slice";
import {
  useAppDispatch,
  useAppSelector,
} from "@persist-middleware/app/store/store";
import { TodoCardView, TodoListView } from "./ui";
import { EmptyState } from "@persist-middleware/components/atoms/EmptyState/EmptyState";
...
import { Counter } from "@persist-middleware/components/molecules/Counter/Counter";
