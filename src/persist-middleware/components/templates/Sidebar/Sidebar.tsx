...
import { useTheme } from "@persist-middleware/app/context/ThemeProvider/ThemeProvider";
import {
  useAppDispatch,
  useAppSelector,
} from "@persist-middleware/app/store/store";
import { setFilter } from "@persist-middleware/app/store/todos/todos-slice";
import { selectFilter } from "@persist-middleware/app/store/todos/todos-selectors";

import s from "./Sidebar.module.scss";
import { useModalStack } from "@persist-middleware/app/context/ModalProvider/ModalProvider";
// import { CreateModal } from "@persist-middleware/components/molecules/CreateModal/CreateModal";
import { CreateTodo } from "@persist-middleware/components/organisms/CreateTodo/CreateTodo";
// import { IoSearch } from "react-icons/io5";
// import { TbTransitionRightFilled } from "react-icons/tb";
import { GiAtomicSlashes } from "react-icons/gi";
import { FaLongArrowAltLeft } from "react-icons/fa";
import { IoIosArrowBack } from "react-icons/io";
import { Tooltip } from "@persist-middleware/components/atoms/Tooltip/Tooltip";
